...
@member_bp.route('/member/dashboard', methods=['GET', 'POST'])
@login_required
def member_dashboard():
    ...
    return render_template('member_dashboard.html',
                           ...
                           workout_history=workout_history[:10], # Limit to last 10
                           chart_labels=chart_labels,
                           chart_data=chart_data,
                           payments=payments)

@member_bp.route('/member/submit-feedback', methods=['POST'])
@login_required
...
@member_bp.route('/member/book', methods=['POST'])
@login_required
